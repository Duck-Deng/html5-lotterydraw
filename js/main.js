$(document).ready(function(){
	...
	function probability0(){
		...
		var num0 = parseInt(Math.random()*clientUnit);	
		var num = parseInt(num0);		
		angles = (360*6) * rotNum + (360*5) + (num0 * 360 / clientUnit);	

		notice = info[clickNum-num];
				
		alert("angles=" + angles + ";%360="+ angles%360);		
	...
	function probability(){
		...
		//alert("clientUnit="+clientUnit+" ;angles=" + angles + " ;%360="+ angles%360);		
